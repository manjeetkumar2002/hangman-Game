...
const guessText = document.querySelector('.guessed-text b');
...
function initGame(button,clickLetter){
    // Their are two chances 
    if(currentWord.includes(clickLetter)){
        console.log("letter is present in word");
        // when the letter exist then will we show it in the wordDisplay
        // we will also push it into the correctLetters
        [...currentWord].forEach((letter,index)=>{
            if(letter ===  clickLetter){
                // insert it into the wordDisplay
